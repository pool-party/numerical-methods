...
| Критерий окончания итераций **(TBD)** | - | Spectral radius of matrix is less than 1, aborting calculation (см. комментарии) | tbd | tbd | tbd | - |
...
| Критерий окончания итераций **(TBD)** | - | Spectral radius of matrix is less than 1, aborting calculation (см. комментарии) | tbd | tbd | Малость невязки | - |
