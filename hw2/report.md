...
//TODO:
// Проверить все критерии окончания итераций

// Проверить, правильно ли указано, где использовались изначальные, а где симметричные матрицы
...
// Раньше Зайдель и Градиенты давали одинаковый ответ на Гильберта, разобраться и, если что, пофиксить.
// Теперь в Гильберте даже ничего общего просто нет, выглядит печально.

// Просмотреть все еще раз, может что-то забыл
